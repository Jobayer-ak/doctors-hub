    ...
    <div className="">
      ...
      <div className="grid grid-cols-2 md:grid md:grid-cols-3 lg:grid lg:grid-cols-6 gap-2 my-3 px-4 w-full lg:max-w-[100%] text-center">
        {doctorArray.map((department, i) => (
          <button
            className={ active === department? "font-bold text-white md:text-sm bg-[#0a062c] transition-all ease-in-out py-2 rounded-md":"font-bold text-white md:text-sm bg-[#4a1a98] hover:bg-[#0a062c] transition-all ease-in-out py-2 rounded-md"}
